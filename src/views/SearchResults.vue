<template>
    <div>
     <main v-if="!loading">
      <h6 class="font-bold text-3xl mb-8" >Results</h6>
    ...
    export default {
      ...
      methods: {
        async fetchArticleData(){
          const res= await fetch(`https://newsapi.org/v2/top-headlines?q=${this.$route.params.searchText}&apiKey=5b5bc8d7095e4950bead99416b21f771`)
          const data = res.json()
          console.log (data)
          return data
        },
